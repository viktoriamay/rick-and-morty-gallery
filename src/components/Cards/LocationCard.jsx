...
export const LocationCard = ({ location }) => {
  ...
  return (
    <Link to={`/location/${location?.id}`} className={`card ${theme}`}>
      ...
      <div className="card__info_wrapper">
        ...
        <p className={`card__info ${theme}`}>
          {parameter(location?.type, ' Type')}
        </p>
        <p className={`card__info ${theme}`}>
          {parameter(location?.dimension, ' Dimension')}
        </p>
        <p className={`card__info ${theme}`}>
          {t('residents')}: {location?.residents?.length}
        </p>
      </div>
    </Link>
  );
